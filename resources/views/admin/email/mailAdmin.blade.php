                   ...
                   <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:left top" width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                      ...
                      <tr > 
                          <ul class="ul" style="margin-top: 20px;">
                            <li style="text-align: left;line-height: 1.6;letter-spacing: 0.3px;border:none !important;float: left">
                              <a href="https://Payments System" target="_blank" ><img src="{{asset('public/sarey.png')}}" alt="" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;margin-top:6px !important;" width="140"></a> 
                     ...
                     <tr > 
                          <ul class="ul">
                            ...
                            <li class="li" style="text-align:right !important;line-height: 1.6;letter-spacing: 0.3px;float: right;"><span>Payment Date </span><span style="display:block;margin-top:6px;margin-right:3px;"> 
                              @php
                     ...
                     <tr style="border-collapse:collapse"> 
                        <td align="center" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;font-size:0px;">
                                <img src="{{asset('public/assets/images/email.jpg')}}"  height="300px" style="padding-top:20px">
                        </td> 
                     </tr>

                     <tr style="border-collapse:collapse"> 
                        <td>
                            <div class="jumb" style="padding:30px;background:rgb(252, 252, 252); font-family:Roboto, sans-serif !important; font-size:12px;">
                                <div class="amount" style="border-bottom:1px solid #ccc;">
                                    <p style="line-height: 1.6;letter-spacing: 0.3px;float:left">Project Name</p>
                                    <p style="line-height: 1.6;letter-spacing: 0.3px;float:right">{{$project_name}}</p>
                                    <div style="clear:both"></div>
                                </div> 
                                <div class="amount" style="border-bottom:1px solid #ccc;">
                                    <p style="line-height: 1.6;letter-spacing: 0.3px;float:left">Client Name</p>
                                    <p style="line-height: 1.6;letter-spacing: 0.3px;float:right">{{$client_name}}</p>
                                    <div style="clear:both"></div>
                                </div> 
                                <div class="amount" style="border-bottom:1px solid #ccc;">
                                    <p style="line-height: 1.6;letter-spacing: 0.3px;float:left">Client Email</p>
                                    <p style="line-height: 1.6;letter-spacing: 0.3px;float:right">{{$client_email}}</p>
                                    <div style="clear:both"></div>
                                </div>
                                <div class="amount" style="border-bottom:1px solid #ccc;">
                                    <p style="line-height: 1.6;letter-spacing: 0.3px;float:left">Method</p>
                                    <p style="line-height: 1.6;letter-spacing: 0.3px;float:right">{{$method}}</p>
                                    <div style="clear:both"></div>
                                </div>
                                <div class="amount" style="border-bottom:1px solid #ccc;">
                     ...
                     <tr style="border-collapse:collapse"> 
                      <td align="center" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:10px;padding-bottom:40px">
                     ...
                     {{-- <tr style="border-collapse:collapse"> 
                      <td > 
                        <div style="background:#E30613;padding:30px 0; margin:0 -20px;">
