          ...
          <td style="padding:0;Margin:0;background-color:#FAFAFA" bgcolor="#fafafa" align="center"> 
           ...
           <table class="es-content-body" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center"> 
             <tr style="border-collapse:collapse"> 
              ...
              <td style="padding:0;Margin:0;padding-left:20px;padding-right:20px;background-color:transparent" bgcolor="transparent" align="left" class="mobile"> 
                 ...
                 <tr style="border-collapse:collapse"> 
                  ...
                  <td valign="top" align="center" style="padding:0;Margin:0;width:560px"> 
                   <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:left top" width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                    ...
                    <tr style="border-collapse:collapse"> 
                      <td > 
                        <div style="background:#E30613;padding:20px 0; margin:0 -20px;">
                            <h5 style="text-align:center;color:white;font-family:Roboto, sans-serif !important;letter-spacing: 3px;">Thank you for Your Payment</h5>
                        </div>
                    </td> 
                     </tr>
                     ...
                     <tr style="border-collapse:collapse"> 
                        <td align="center" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;font-size:0px;">
                                <img src="{{asset('public/assets/images/thanks.jpg')}}"  height="260px" style="padding-top:20px">
                        </td> 
                     </tr>

                     <tr style="border-collapse:collapse"> 
                        <td>
                            <div class="jumb" style="padding:20px 30px;background:rgb(252, 252, 252); font-family:Roboto, sans-serif !important; font-size:12px;">
                                <div class="amount" style="border-bottom:1px solid #ccc;">
                                    <p style="line-height: 1.6;letter-spacing: 0.3px;float:left">Invoice Number</p>
                                    <p style="line-height: 1.6;letter-spacing: 0.3px;float:right">INV-00{{$invoice_number}}</p>
                                    <div style="clear:both"></div>
                                </div>
                                <div class="amount" style="border-bottom:1px solid #ccc;">
                                    <p style="line-height: 1.6;letter-spacing: 0.3px;float:left">Payment Date</p>
                                    <p style="line-height: 1.6;letter-spacing: 0.3px;float:right">
                                      @php
                     ...
                     <tr style="border-collapse:collapse"> 
                        <td > 
                            <div style="padding:30px 0; margin:0 -20px;text-align:center;">
                                <a href="https://sarey.co" target="_blank" style="margin:text-align:center"><img src="{{asset('public/sarey.png')}}" alt="" style="margin:0 auto;:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" width="140"></a> 
                            </div>
                        </td> 
                     </tr>
