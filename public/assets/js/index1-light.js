	...
	var myChart = new Chart(myCanvas, {
		...
		data: {
			...
			datasets: [{
				...
				backgroundColor:'rgb(106, 178, 245)',
				hoverBackgroundColor: 'rgb(106, 178, 245)',
				hoverBorderWidth: 2,
				hoverBorderColor: 'rgb(106, 178, 245)'
			}, {

			    label: 'Completed Tasks',
				data: [10, 14, 10, 15, 9, 14, 15, 14],
				backgroundColor: 'rgba(106, 178, 245, 0.7)',
				hoverBackgroundColor:'rgba(106, 178, 245, 0.7)',
				hoverBorderWidth: 2,
				hoverBorderColor: 'rgba(106, 178, 245, 0.7)'
